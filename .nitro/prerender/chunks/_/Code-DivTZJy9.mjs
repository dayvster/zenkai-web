...
const Navi = () => {
  return ssr(_tmpl$$7, ssrHydrationKey(), escape(NavItems.map((item) => {
    return ssr(_tmpl$2$2, ssrHydrationKey() + ssrAttribute("href", escape(item.href, true), false), escape(item.label));
...
var _tmpl$$2 = '<circle cx="13.5" cy="6.5" r=".5" fill="currentColor"></circle>', _tmpl$2 = '<circle cx="17.5" cy="10.5" r=".5" fill="currentColor"></circle>', _tmpl$3 = '<circle cx="8.5" cy="7.5" r=".5" fill="currentColor"></circle>', _tmpl$4 = '<circle cx="6.5" cy="12.5" r=".5" fill="currentColor"></circle>', _tmpl$5 = '<path d="M12 2C6.5 2 2 6.5 2 12s4.5 10 10 10c.93 0 1.5-.67 1.5-1.5 0-.39-.15-.74-.39-1.01-.23-.26-.38-.61-.38-1 0-.83.67-1.5 1.5-1.5H16c3.31 0 6-2.69 6-6 0-5.5-4.5-10-10-10z"></path>';
const Palette = (props) => {
  const [local, rest] = splitProps(props, ["size", "class"]);
  return ssrElement("svg", mergeProps({
    xmlns: "http://www.w3.org/2000/svg",
...
//# sourceMappingURL=Code-DivTZJy9.mjs.map
