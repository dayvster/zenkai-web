      ...
      return [createComponent(_components.h1, {
        ...
        get children() {
          return ["\n", createComponent(_components.li, {
            ...
            children: "Results are ranked by frequency - frequently used apps appear first"
          }), "\n", createComponent(_components.li, {
            get children() {
              return ["Use ", createComponent(_components.code, {
                children: "--show-actions"
              }), " to reveal [Desktop Action] entries on each item"];
            }
          }), "\n", createComponent(_components.li, {
            get children() {
              return ["Keyboard shortcuts can be extended via the Lua plugin system using ", createComponent(_components.code, {
                children: "zenkai.bind()"
              })];
            }
          }), "\n"];
        }
...
//# sourceMappingURL=shortcuts-DC3DrjGl.mjs.map
