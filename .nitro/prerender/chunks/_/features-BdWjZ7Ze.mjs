...
import { M as MainLayout, S as Search, P as Plugin, a as Palette, F as Folder, C as Code, b as Card, B as Button, D as Download } from './Code-DivTZJy9.mjs';
import 'file:///home/dave/Workspace/zenkai-web/node_modules/.pnpm/solid-js@1.9.11/node_modules/solid-js/dist/server.js';

var _tmpl$ = ["<h2", ' class="text-2xl text-white font-bold">Ready to try Zenkai?</h2>'], _tmpl$2 = ["<p", ' class="max-w-lg mx-auto text-muted">Download the latest release and experience the fastest app launcher for Linux and macOS.</p>'], _tmpl$3 = ["<div", ' class="flex justify-center">', "</div>"], _tmpl$4 = ["<div", ' class="px-4 sm:px-6 py-12 sm:py-20 max-w-6xl mx-auto"><div class="text-center mb-16"><h1 class="text-4xl sm:text-5xl lg:text-6xl font-black text-white mb-4">Everything <span class="text-primary">Zenkai</span></h1><p class="text-fg text-lg max-w-2xl mx-auto">A fast app launcher for Linux and macOS built with Zig and Qt6. Every feature designed for speed, flexibility, and control.</p></div><!--$-->', "<!--/--><!--$-->", "<!--/--></div>"], _tmpl$5 = ["<div", ' class="mb-16"><h2 class="text-2xl sm:text-3xl font-black text-white mb-8 flex items-center gap-3"><span class="w-1.5 h-8 bg-primary rounded-full"></span><!--$-->', '<!--/--></h2><div class="grid grid-cols-1 md:grid-cols-2 gap-6">', "</div></div>"], _tmpl$6 = ["<div", ' class="flex items-start gap-4"><div class="shrink-0 w-10 h-10 rounded-lg bg-primary/10 flex items-center justify-center">', '</div><div class="flex-1 min-w-0"><h3 class="text-lg font-bold text-white">', '</h3><p class="text-sm text-fg leading-relaxed mt-1">', "</p></div></div>"], _tmpl$7 = ["<div", ' class="grid grid-cols-2 gap-2 mt-2">', "</div>"], _tmpl$8 = ["<div", ' class="flex items-center gap-2 text-xs text-muted"><span class="w-1 h-1 rounded-full bg-primary shrink-0"></span><!--$-->', "<!--/--></div>"];
...
//# sourceMappingURL=features-BdWjZ7Ze.mjs.map
